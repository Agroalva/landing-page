      ...
      },
      {
        ...
        attributes: [
          ...
          },
          {
            ...
            type: "select",
            options: toOptions(["Directa", "Convencional", "Otro"]),
          },
          {
            id: "cultivation",
            label: "Cultivo / Uso",
      ...
      },
      {
        ...
        attributes: [
          ...
          },
          {
            ...
            type: "select",
            options: toOptions(["Convencional", "Axial", "Mixto", "Otro"]),
          },
          {
            id: "power_range",
            label: "Potencia",
        ...
        attributes: [
          {
            ...
            label: "Tipo",
            type: "select",
            options: toOptions(["Noria transportadora", "Extractora", "Procesadora", "Clasificador de semillas", "Chipeadora", "Inoculador", "Otro"]),
          },
          ...commonMachineryAttributes,
        ],
      },
      ...
      },
      {
        ...
        attributes: [
          ...
          },
          {
            ...
            type: "select",
            options: toOptions(["De arrastre", "De tiro", "Otro"]),
          },
          ...commonMachineryAttributes,
        ],
      },
        ...
        attributes: [
          {
            ...
            label: "Categoría",
            type: "select",
            options: toOptions(["Picadoras de forrajes", "Picadoras de rollos", "Otro"]),
          },
          ...commonMachineryAttributes,
        ],
      },
        ...
        attributes: [
          {
            ...
            label: "Categoría",
            type: "select",
            options: toOptions(["Segadoras de arrastre", "Segadoras autopropulsadas", "Otro"]),
          },
          ...commonMachineryAttributes,
        ],
      },
    ...
    categories: [
      {
        ...
        attributes: [
          ...
          {
            id: "arrime_condition",
            label: "Condición de arrime",
            type: "select",
            options: ARRIME_CONDITIONS,
          },
        ],
      },
      {
        id: "chasis_y_acoplado",
        label: "Chasis y acoplado",
        icon: "car-outline",
        color: "#8D6E63",
        attributes: [
          ...commonMachineryAttributes,
    ...
    categories: [
      {
        ...
        attributes: [
          ...
          },
          {
            ...
            label: "Oficio o rol",
            type: "text",
            placeholder: "Ej: Tractorista, peón rural, administrativo",
          },
        ],
      },
    ],
